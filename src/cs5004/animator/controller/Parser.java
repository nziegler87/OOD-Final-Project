...
/**
 * A parser class that is used to read a text string of arguments and determine the input file, the
 * type of view, the output location, and the speed of the render.
 */
public class Parser {
  ...
  public Parser(String[] input) {
    ...
    //TODO: Added in this >> updated this to initialize out, not view
